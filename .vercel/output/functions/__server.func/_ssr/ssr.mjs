...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C2TFIYob.mjs");
...
var manifest = {
	"2748136a3810e1344109cd073c261fd1b20f37857efcab2c536086c32317efdf": {
		functionName: "sendMessage_createServerFn_handler",
		importer: () => import("./server-DEFX2H4B.mjs")
	},
	"3fbebc3671122b13df43285bbe06e69128780fee6700430087c5fe5a0cc19df1": {
		functionName: "syncInbox_createServerFn_handler",
		importer: () => import("./server-DEFX2H4B.mjs")
	},
	"52dbc31b755634a82563a1cf07f4362bf255ff415e1a1e7431bfe38b678e5c2b": {
		functionName: "sendReceipts_createServerFn_handler",
		importer: () => import("./server-DEFX2H4B.mjs")
	},
	"55b25fb47ec13ad61c8682dbf2a8b26de7d00e92c74cf3be7e0126a32ea442b8": {
		functionName: "blockUser_createServerFn_handler",
		importer: () => import("./server-DEFX2H4B.mjs")
	},
	"819b0b4efaa45b20ddb6ab25c02ee54e9b1074d10844aecfc8afad563d73ad2a": {
		functionName: "sendCallSignal_createServerFn_handler",
		importer: () => import("./server-DEFX2H4B.mjs")
	},
	"8e108dd2cc150e5c5bb46344103cd16f71d8c852d0c9c4cd1e245bf3b96c6ce6": {
		functionName: "searchUsers_createServerFn_handler",
		importer: () => import("./server-DEFX2H4B.mjs")
	},
	"a3189f67e7a0e318bea90c0c87dd68570f6485003ebff7e8c62d3681fdd78474": {
		functionName: "getMyProfile_createServerFn_handler",
		importer: () => import("./server-DEFX2H4B.mjs")
	},
	"e8fa6613dd254baa924a6b136e67b39d8061bf2718784a0164fa16310d142724": {
		functionName: "createGroup_createServerFn_handler",
		importer: () => import("./server-DEFX2H4B.mjs")
	},
	"f89dbf5998bd1ebacdc943cd99fe9ee3e55c367aa528bffd66eff835265ff473": {
		functionName: "claimProfile_createServerFn_handler",
		importer: () => import("./server-DEFX2H4B.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-bAnbkjeo.mjs").then((n) => n.t),
